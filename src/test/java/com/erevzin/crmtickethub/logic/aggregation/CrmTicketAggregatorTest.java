...
public class CrmTicketAggregatorTest {
    ...
    public void testApply() {
        ...
        expectedAggregates.add(CrmTicketAggregate.builder()
                .id(CrmTicketId.builder().error(100).provider(PROVIDER_1).build())
                .errorCode(100)
                .providerName(PROVIDER_1)
                ...
                .build());
        expectedAggregates.add(CrmTicketAggregate.builder()
                .id(CrmTicketId.builder().error(100).provider(PROVIDER_2).build())
                .errorCode(100)
                .providerName(PROVIDER_2)
                ...
                .build());
        expectedAggregates.add(CrmTicketAggregate.builder()
                .id(CrmTicketId.builder().error(200).provider(PROVIDER_1).build())
                .errorCode(200)
                .providerName(PROVIDER_1)
                ...
                .build());
        expectedAggregates.add(CrmTicketAggregate.builder()
                .id(CrmTicketId.builder().error(300).provider("Provider4").build())
                .errorCode(300)
                .providerName("Provider4")
